...
I could not find anything else at that time, but over the days I realized it should be worth to see how death counts change with different
regions which do not have Code for the data sets malaria deaths and malaria deaths of age.
...
0.89 to 0.29, and by 2016 it reaches 0. While in 2015 this rate is 0.13. Highest death rate was in 1990 with 0.91.
...
Malaria Death count rate can be observed by countries or specific regions given in the data set. There are 7 regions 
...
I will focus of each region separately, because even inside the same region sub parts can behave differently.
The 7 regions are 
...
5. Latin American Region
6. Asian Countries
7. Caribbean and Latin American Countries

# SDI Countries and Malaria Death Count Rate
...
For High middle SDI countries the death rate in 1990 is 0.1168 and in 1996 it reaches the highest point of 0.1281. After 1996 there
clear decrease of death rate which reaches its minimum value of 0.0456 in 2016.
...
ggplot(subset(MD_CM_SDI,Entity == "Middle SDI"  | Entity == "High-middle SDI"),
      ...
      ylab("Deaths - Malaria - Sex: Both \n- Age: Age-standardized \n(Rate) (per 100,000 people)")+ggtitle("High and High-middle SDI Countries")+
      geom_point()+geom_line()+scale_x_continuous(breaks=seq(1990,2016),labels =seq(1990,2016))+ legend_bottom()+
...
# Saharan Region and Malaria Death Count Rate
...
Sub-Saharan Western and Sub-Saharan Africa countries. Here though it does not look like we need to separate these regions 
and plot them as groups. While plotting them as a whole there are clear and interpret-able differences in this line plot.
...
in 2016 the death rate is 2.29 which higher than the previous 7 years from 2016.
...
# European Countries and Malaria Death Count Rate

I believe that European countries had any malaria related deaths even before 1990, because of their weather patterns. That is 
...
# Great Britain or United Kingdom and Malaria Death Count Rate

We consider the collection of these countries as Great Britain or United Kingdom, which are England, Northern Ireland, 
Scotland and Wales. Here also weather pattern do have a high probability in causing a situation of no malaria related deaths.
Further, these four countries are close to the European regions in the previous section therefore this assures us more that
...
# American Countries and Malaria Death Count Rate
...
# Asian Countries and Malaria Death Count Rate

There are 7 regions in the Asian region, which are Oceania, South Asia, Southeast Asia, East Asia,
...
until year 1998 of death rate of 0.0314. After this the death rate decreases gradually until year
...
High Income Asia Pacific countries have a better death rate than previous Asian region countries
...
Oceania region behaves very differently than other regions. The lowest death rate occurs to High Income 
Asian Pacific region than other regions of Asia. By the year 2016 highest death rate of 8.71 occurs for
Oceania region.
...
Comparing all the other region in this data set only North Africa and Middle East Region 
was very special with its odd fluctuations which are odd. At the end comparing the 
death rates of year 1990 and 2016 there is an increase close to 0.04, but it is far less than
what was in year 2005.
...
0.1519. Further it decreases over the years with some fluctuations in some years. By year 2016
...
_Please see that_  
This is my first post on the internet so please be kind to tolerate my mistakes in grammar and spellings. 
