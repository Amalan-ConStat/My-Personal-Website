...
tags:
  ...
  - R package
image:
  caption: 'Movie profit data-set has around 3500 movies. Genre, MPAA Rating, Production budget, Release data Domestic gross and World wide gross are important variables. The range of variables are limited for categorical variables, but very wide for numerical variables.'
  focal_point: ''
---
...
_Please see that_ This is my first post on the internet so please be kind to tolerate my 
