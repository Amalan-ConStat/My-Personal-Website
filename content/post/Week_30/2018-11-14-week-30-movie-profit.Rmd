...
dataset. Even though the title of data says Movie profit I am going to focus on the movies which did not 
...
Yet 645 Drama movies are R-rated.There is only one action movie for general audiences(for all) and obviously no horror 
film should be watched by children alone, yet there are 7 movies which you can watch with your parents.
...
This dataset contains the release dates from 1956 to 2019. Even though it is not 2019 there is a movie which 
...
be onit in the first place. We have 66 movies to consider.  
...
Here also there are 11 movies with have not been classfied into any rating. Finally, there is no G rated movie in 
...
Considering the boxplot there are 3 outliers in Drama while plotting data in perspective of genre. Most amount of 
...
dollars, similarly a movie from adventure category spent more than 100 million dollars. Others prodcution budget is 
way less than 50 milion USD. 
...
didnot pertain any information of gross domestic or worldwide.
...
Considering the months there is no speciality most of the counts are inbetween 3 and 8. In january there are 
only two movies.
...
* This missing information could be the realted to the fact that there are 4 movies which were released before 1972. 
  Oddly in 2014 there are 8 movies which do not contain domestic gross information. Further, most of these movies 
  were realesed after year 2000.
