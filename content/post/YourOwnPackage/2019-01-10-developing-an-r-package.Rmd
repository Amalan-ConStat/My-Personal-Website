...
Following coding standards is really the most basic of all the things related to programming
in any language, this is considered in R package development as well. Simply speaking defining
variables and functions, naming variables and functions, choosing input parameters and output 
parameters, considering the type of inputs and outputs are in this list. This is highly encouraged
so that in the future if someone other than the initial developer intends to improve or change a certain
structure of the code. 

These traits will be quite useful or if anyone wishes to understand the code 
as well. In a CRAN or GitHub released package which is accessible by anyone a user 
has the ability to view the code for the function therefore it is crucial to maintain
coding standards. 

Also comment regularly in between functions to make it clearer about what is happening or
what the code is expected to do. Maintaining these standards will be very useful when your
package has alot of grouped functions or a function with more than hundred lines of code.

```{r adding image to sample function}
