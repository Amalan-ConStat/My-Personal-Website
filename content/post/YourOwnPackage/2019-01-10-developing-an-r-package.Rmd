...
* Comment regularly to make the functions sense.
...
* Example - tests direcotyr, README.Rmd, ...
...
* Using Rmarkdown generate an github output document.
...
for each function and data sets will be in the man directory.
