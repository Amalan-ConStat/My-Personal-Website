...
The [Tweet](https://twitter.com/Amalan_Con_Stat/status/1071369742672429056)
...
```{r word cloud for Top 10 Authors,fig.width=5,fig.height=5}
...
```{r word cloud for Top 5 publications,fig.width=5.75,fig.height=5.75}
#convert into data frame
...
* Using dplyr to manipulate the datset was useful when there is complication.
