...
[Data](https://github.com/rfordatascience/tidytuesday/blob/master/data/2018-11-27/baltimore_bridges.csv) for the analysis and [description](https://github.com/rfordatascience/tidytuesday/tree/master/data/2018-11-27) about the Baltimore bridges are hyper-linked. Further , my [tweet](https://twitter.com/Amalan_Con_Stat/status/1067650979129118720) is also in this hyperlink.
...
ggplot(subset(bridges,`Year Built`=="1957" | `Year Built`=="1970" | `Year Built`=="1975" | 
                `Year Built`=="1991" | `Year Built`=="1963" | `Year Built`=="1961")
