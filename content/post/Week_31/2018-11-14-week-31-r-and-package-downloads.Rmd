...
My main objective is to understand how Sri Lankan users have behaved in this dataset. 
...
```{r Sri Lanka data extraction,echo=FALSE,warning=FALSE,include=FALSE}
...
```{r Operating Systems, echo=FALSE, fig.height=6, fig.width=6, warning=FALSE}
...
```{r R versions, echo=FALSE, fig.height=6, fig.width=6, warning=FALSE}
...
```{r R versions 2,echo=FALSE,fig.height=6,fig.width=6,warning=FALSE}
...
```{r R versions 3,echo=FALSE,fig.height=6,fig.width=6,warning=FALSE}
...
Windows operating system percentages indicate that 34.66% of users have choosen version 3.5.1,
...
```{r Date versus Operating system 1,echo=FALSE, fig.height=6, fig.width=6, warning=FALSE}
...
higher amount than anyother month. Except August only the month of December has counts higher 
than 100. 

```{r Date versus Operating system 2,echo=FALSE, fig.height=7, fig.width=7, warning=FALSE }
...
```{r Date versus Operating system 3,echo=FALSE, fig.height=7, fig.width=7, warning=FALSE}
...
```{r Date versus Operating system2,echo=FALSE, fig.height=9, fig.width=9, warning=FALSE}
...
```{r Size classification,echo=FALSE, fig.height=8, fig.width=8, warning=FALSE}
...
```{r IP ID classification,echo=FALSE, fig.height=8, fig.width=8, warning=FALSE}
