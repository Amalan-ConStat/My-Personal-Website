...
NR_answer<-maxLik(logLik =formaxLik, start = c(0.1,0.2),
                      method = "NR")
...
BFGS_answer<-maxLik(logLik =formaxLik, start = c(0.1,0.2),
                      method = "BFGS")
...
BFGSR_answer<-maxLik(logLik =formaxLik, start = c(0.1,0.2),
                      method = "BFGSR")
...
SANN_answer<-maxLik(logLik =formaxLik, start = c(0.1,0.2),
                      method = "SANN")
...
CG_answer<-maxLik(logLik =formaxLik, start = c(0.1,0.2),
                      method = "CG")
...
NM_answer<-maxLik(logLik =formaxLik, start = c(0.1,0.2),
                      method = "NM")
