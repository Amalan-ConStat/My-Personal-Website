...
Comparing p-values it is clear that all analytical methods generate the same value upto third 
decimal point. This is not the case in Maximum Log Likelihood value where analytical methods
NR, BFGS, CG and NM have obtained the value -813.4571, while BFGSR and SANN have -813.4576. Further,
Over-dispersion values are similar until third decimal point, but after that threre is clear difference
...
the method analytical method from maxLik function based on your needs of output and 
research objective.
