...
all over the place. Yet there is an odd occuring of negative values for average delay with all
departing for some cities after mid of year 2017. 

Well none of these negative values does not exceed -2.5, where the maximum average dealy in 
all departing is close to 5.5. I belive unit measured is in minutes.
